...
function buildOrganicOptions(defN: number, defP: number, defK: number, areaHa: number): OrganicOption[] {
...
function buildChemicalFertilizers(defN: number, defP: number, defK: number, areaHa: number): ChemicalFertilizer[] {
...
function buildSchedule(crop: string): { stage: string; stageHi: string; products: string }[] {
  const base = [
