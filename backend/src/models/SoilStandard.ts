...
const soilStandardSchema = new Schema<ISoilStandard>({
...
export const SoilStandard = mongoose.model<ISoilStandard>('SoilStandard', soilStandardSchema);

// Indian soil benchmark data to seed
export const SOIL_STANDARDS_DATA = [
  {
    soilType: 'Alluvial',
