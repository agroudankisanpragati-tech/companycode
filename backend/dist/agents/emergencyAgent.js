...
exports.runEmergencyAgent = runEmergencyAgent;
...
5. Stay in open air`;
function detectEmergencyType(msg) {
    const lower = msg.toLowerCase();
    if (/poison|toxic|pesticide.*poison|विष|कीटनाशक.*विषाक्त/.test(lower))
        return 'poison';
    if (/flood|waterlog|बाढ़|जलभराव|drought|सूखा/.test(lower))
        return 'flood';
    if (/pest|insect|locust|टिड्डी|aphid|whitefly|कीट/.test(lower))
        return 'pest';
    return 'general';
}
async function runEmergencyAgent(ctx) {
...
//# sourceMappingURL=emergencyAgent.js.map