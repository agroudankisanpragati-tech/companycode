...
exports.prepareForIntentDetection = prepareForIntentDetection;
exports.getAliasesForDomain = getAliasesForDomain;
 ...
 */
function prepareForIntentDetection(raw) {
    if (!raw?.trim())
        return raw;
    ...
    if (lower.includes(result.canonical.toLowerCase()))
        return raw;
...
//# sourceMappingURL=aliasNormalizer.js.map