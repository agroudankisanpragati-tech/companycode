...
exports.getVoiceBcp47ForCode = getVoiceBcp47ForCode;
const LANG_BCP47 = {
...
function getVoiceBcp47ForCode(langCode) {
    if (!langCode)
        return 'hi-IN';
    if (langCode.includes('-'))
        return langCode; // already BCP-47
    return LANG_BCP47[langCode] || 'hi-IN';
}
//# sourceMappingURL=voiceEngineHelpers.js.map